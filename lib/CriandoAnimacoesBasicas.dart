...
class _CriandoAnimacoesBasicasState extends State<CriandoAnimacoesBasicas> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        /* nesses casos são animações implicitas, no qual não temos total controle sobre as animações */
...
/*       animação do aviao
        ...
        floatingActionButton: FloatingActionButton(
          ...
          onPressed: () {
            /* cada vez que o floating action button for clicado o status será mudado */
            setState(() {
              _status = !_status;
            });
          },
